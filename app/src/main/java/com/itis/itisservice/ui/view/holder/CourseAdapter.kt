...
class CourseAdapter(groups: List<ExpandableGroup<*>>, var listener: (Course) -> (Unit)) : ExpandableRecyclerViewAdapter<ListCoursesViewHolder, CourseViewHolder>(groups) {
    ...
    override fun onBindChildViewHolder(holder: CourseViewHolder, flatPosition: Int, group: ExpandableGroup<*>, childIndex: Int) {
        ...
        holder.bind(course, listener = listener)
    }
